...
urlfile = "https://raw.githubusercontent.com/AKirol/Lake-Carmi/master/Carmi%20Data%20-%20Carmi%20Latest%20Data.csv"
carmidata <- read.csv(url(urlfile))

meturl = "https://raw.githubusercontent.com/AKirol/Lake-Carmi/master/Carmi%20Data%20-%20CarmiMet.csv"
carmimet <- read.csv(url(meturl))
mettable <- carmimet[,c(3,7,9)]
...
mytable$Air <- tail(mettable$Temperature..S.THB.10979906.10974876.1....C..Bree_met_5,1)
names(mytable)[6] <- "Air Temperature (*C)"
mytable$WS <- tail(mettable$Wind.Speed..S.WSB.10979906.10955814.1...m.s..Bree_met_5,1)
...
mytable$Wdir <- tail(mettable$Wind.Direction..S.WDA.10979906.10969970.1......Bree_met_5,1)
